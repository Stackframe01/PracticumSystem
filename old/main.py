...
def main():
    ...
    for professional_standard in extractor.get_professional_standards(
            downloader.get_latest_downloaded_professional_standards()):
        for generalized_work_function in extractor.get_generalized_work_functions(professional_standard):
            ...
            if len(key_skills) != 0:
                ...
                exporter.add_key_skills(professional_standard['NameProfessionalStandart'],
            ...
            if len(requirements) != 0:
                ...
                exporter.add_requirements(professional_standard['NameProfessionalStandart'],
            ...
            if len(professional_standards) != 0:
                exporter.add_professional_standards(professional_standard['NameProfessionalStandart'],
