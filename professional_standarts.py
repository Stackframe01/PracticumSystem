...
def get_standarts():
    ...
    for generalized_work_function in dataset['XMLCardInfo']['ProfessionalStandarts']['ProfessionalStandart']['ThirdSection']['WorkFunctions']['GeneralizedWorkFunctions']['GeneralizedWorkFunction']:
